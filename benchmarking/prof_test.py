...

{
    ...
    "ground_truth": {
        ...
        "tier_3": []  # No tier 3 for this query
    }
},
...
<head>
    ...
    <title>Profession Embedding Benchmark Report</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🏆 Profession Embedding Benchmark Report</h1>
...
def run_benchmark():
    ...
    # ========================
    json_path = Path(__file__).parent / "prof_results.json"
